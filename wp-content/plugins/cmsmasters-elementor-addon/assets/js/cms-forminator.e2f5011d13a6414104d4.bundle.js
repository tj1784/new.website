...
"use strict";
(self["webpackChunkcmsmasters_elementor_addon"] = self["webpackChunkcmsmasters_elementor_addon"] || []).push([["cms-forminator"],{
...
/***/ "../modules/contact-form/assets/dev/js/frontend/handlers/cms-forminator.js":
/*!*********************************************************************************!*\
  !*** ../modules/contact-form/assets/dev/js/frontend/handlers/cms-forminator.js ***!
  \*********************************************************************************/
...
class CmsForminator extends _handler.default {
  onInit() {
    super.onInit();
    const widgetId = `cms-${this.getID()}`;
    this.$element.on('click', '.forminator-datepicker', () => {
      // Use only click event
      jQuery('#ui-datepicker-div').attr('data-widget-id', widgetId);
    });
    const observer = new MutationObserver((mutationsList, observerInstance) => {
      mutationsList.forEach(mutation => {
        mutation.addedNodes.forEach(node => {
          if (node.nodeType === 1 && node.classList.contains('select2-container--open')) {
            jQuery(node).attr('data-widget-id', widgetId);
          }
        });
      });
    });
...
exports["default"] = CmsForminator;

/***/ })

}]);
//# sourceMappingURL=cms-forminator.e2f5011d13a6414104d4.bundle.js.map