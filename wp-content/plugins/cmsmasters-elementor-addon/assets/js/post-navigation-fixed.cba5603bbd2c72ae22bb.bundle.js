...
"use strict";
(self["webpackChunkcmsmasters_elementor_addon"] = self["webpackChunkcmsmasters_elementor_addon"] || []).push([["post-navigation-fixed"],{
...
/***/ "../modules/template-pages/assets/dev/js/frontend/handlers/post-navigation-fixed.js":
/*!******************************************************************************************!*\
  !*** ../modules/template-pages/assets/dev/js/frontend/handlers/post-navigation-fixed.js ***!
  \******************************************************************************************/
...
class PostNavigationFixed extends _handler.default {
  getDefaultElements() {
    const postNav = 'elementor-widget-cmsmasters-post-navigation-fixed';
    const elements = {
      $navPrev: this.findElement(`.${postNav}__prev-wrap`),
      $navNext: this.findElement(`.${postNav}__next-wrap`)
    };
    return elements;
  }
  onInit() {
  ...
  navHeight() {
    const navPrev = this.elements.$navPrev;
    const prevHeight = navPrev.find('.elementor-widget-cmsmasters-post-navigation-fixed__link').height();
    const navNext = this.elements.$navNext;
    const nextHeight = navNext.find('.elementor-widget-cmsmasters-post-navigation-fixed__link').height();
    navPrev.css({
...
exports["default"] = PostNavigationFixed;

/***/ })

}]);
//# sourceMappingURL=post-navigation-fixed.cba5603bbd2c72ae22bb.bundle.js.map