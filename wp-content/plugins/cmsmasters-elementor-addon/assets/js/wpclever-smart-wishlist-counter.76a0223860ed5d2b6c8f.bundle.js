...
"use strict";
(self["webpackChunkcmsmasters_elementor_addon"] = self["webpackChunkcmsmasters_elementor_addon"] || []).push([["wpclever-smart-wishlist-counter"],{
...
/***/ "../modules/woocommerce/assets/dev/js/frontend/widgets/wpclever-smart-wishlist-counter.js":
/*!************************************************************************************************!*\
  !*** ../modules/woocommerce/assets/dev/js/frontend/widgets/wpclever-smart-wishlist-counter.js ***!
  \************************************************************************************************/
...
class WpcleverSmartWishlistCounter extends _handler.default {
  getDefaultElements() {
    return {
      $selector: this.findElement('.header-wishlist .count')
    };
  }
  onInit() {
  ...
  changeCount() {
    jQuery('body').on('woosw_change_count', (event, count) => {
      this.elements.$selector.html(count);
    });
  }
}
exports["default"] = WpcleverSmartWishlistCounter;

/***/ })

}]);
//# sourceMappingURL=wpclever-smart-wishlist-counter.76a0223860ed5d2b6c8f.bundle.js.map