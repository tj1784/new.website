...
"use strict";
(self["webpackChunkcmsmasters_elementor_addon"] = self["webpackChunkcmsmasters_elementor_addon"] || []).push([["wpclever-smart-compare-counter"],{
...
/***/ "../modules/woocommerce/assets/dev/js/frontend/widgets/wpclever-smart-compare-counter.js":
/*!***********************************************************************************************!*\
  !*** ../modules/woocommerce/assets/dev/js/frontend/widgets/wpclever-smart-compare-counter.js ***!
  \***********************************************************************************************/
...
class WpcleverSmartCompareCounter extends _handler.default {
  getDefaultElements() {
    return {
      $selector: this.findElement('.header-compare .count')
    };
  }
  onInit() {
  ...
  changeCount() {
    jQuery('body').on('woosc_change_count', (event, count) => {
      this.elements.$selector.html(count);
    });
  }
}
exports["default"] = WpcleverSmartCompareCounter;

/***/ })

}]);
//# sourceMappingURL=wpclever-smart-compare-counter.b55849e0791460500ad7.bundle.js.map