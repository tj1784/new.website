...
"use strict";
(self["webpackChunkcmsmasters_elementor_addon"] = self["webpackChunkcmsmasters_elementor_addon"] || []).push([["timetable"],{
...
/***/ "../modules/timetable/assets/dev/js/frontend/handlers/timetable.js":
/*!*************************************************************************!*\
  !*** ../modules/timetable/assets/dev/js/frontend/handlers/timetable.js ***!
  \*************************************************************************/
...
class Timetable extends _handler.default {
  onInit() {
    super.onInit();
    if (this.$element.find('.mptt-shortcode-wrapper').length && !this.$element.find('.mptt-shortcode-wrapper').hasClass('table-init')) {
      mptt.tableInit();
    }
  }
}
...
//# sourceMappingURL=timetable.f589e663ef85d1df8d56.bundle.js.map